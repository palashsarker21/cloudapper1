...
export const forceSyncCatalog = createServerFn({ method: "POST" })
  .handler(async () => {
    ...
    for (const ext of extensions) {
      const productData: ProductInsert = {
        ...
        product_type: 'browser_extensions' as any,
        inventory_type: 'license' as any,
        delivery_method: 'license_key' as any,
